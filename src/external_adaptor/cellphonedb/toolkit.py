...
def search_df(df_all, search_dict=None, cell_any=None):
    """
    ...
    search_dict 示例：
    {
        ...
        "cell_left": ["CD4 Th17", "ILC3"]
    }

    cell_any 示例：
    ["CD4 Th17", "ILC3"]  # 同时在 cell_left 或 cell_right 中出现
    """
    df = df_all.copy()
